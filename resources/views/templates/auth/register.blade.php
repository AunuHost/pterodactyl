@include('templates.Carbon.inc.LoginAnimation')
    ...
    <header>
      ...
      <div class="logo" style="display: flex; align-items: center;">
        ...
        <div class="logo"><a href="/">{{ config('app.name', 'AunuPanel') }}</a></div>
      </div>
    ...
    @endif
          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <p class="cyh04c-7 fFcOT">© 2015 - 2025&nbsp;<a rel="noopener nofollow noreferrer" href="https://aunuhost.web.id" target="_blank" class="cyh04c-8 emCXNB">AunuPanel Software</a></p>
            </div>
          </div>
        </div>
      </div>
